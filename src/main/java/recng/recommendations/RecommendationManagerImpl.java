...
/**
 * The manager for making recommendations.
 *
 * Nothing but a prototype at the moment.
 * 
 * @author jon
 * 
 */
public class RecommendationManagerImpl implements RecommendationManager {
    ...
    private List<ProductQuery> getTemplateQueries(String templateName) {
        ...
        ProductQueryImpl q0 =
            new ProductQueryImpl(5, RecommendationEdgeType.PEOPLE_WHO_BOUGHT);
        q0.setFilter(getFilter(templateName, 0));
        ProductQueryImpl q1 =
            new ProductQueryImpl(5, RecommendationEdgeType.PEOPLE_WHO_VIEWED);
    ...
    private int getTemplateLimit(String templateName) {
        return DEFAULT_LIMIT; // TODO: Get from template
    }
